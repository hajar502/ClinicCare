...
<?php
$id = $_GET['id'];
$result = mysqli_query($con,"SELECT * FROM alternatives WHERE alternativeID='$id'");  
$row = mysqli_fetch_array($result);
?>
                <!-- form -->
                <div class="col-lg-6">
                    <div class="bg-light  rounded p-5">
                        <h1 class="mb-4">Edit Alternative</h1>
                        <form action="update-alternative.php?id=<?php echo $row['alternativeID'] ?>" method="POST">
                            <div class="row g-3">
                            <div class="col-12 col-sm-12">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" type="submit">Update Alternative</button>
                                </div>
                            </div>
                        </form>
                    </div>
