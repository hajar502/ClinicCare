...
<?php
$diseaseID = $_GET['id'];
$result1 = mysqli_query($con,"SELECT * FROM diseases WHERE diseaseID='$diseaseID'");
$row1 = mysqli_fetch_array($result1);
$specialtyID = $row1['specialtyID'];

$result2 = mysqli_query($con,"SELECT * FROM specialties WHERE specialtyID='$specialtyID'");
$row2 = mysqli_fetch_array($result2);
$specialtyID = $row2['specialtyID'];
?>
<body>
            ...
            <div class="mb-4">
                    ...
                    <div class="col-sm-12 col-12">
                            <div class="bg-success p-4">
                                <h6 class=" text-white mb-0">From your entered sypmtoms: It's expexted that these are symptom of <?php echo $row1['name'] ?>
                                <br> Below you can find doctors for this disease!</h6>
                            </div>
                        </div>
